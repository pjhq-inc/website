...
var counterRef = db.collection("counters").doc("count");
var counterDisplay = document.getElementById("counter");
var incrementButton = document.getElementById("increment");
function updateCounter() {
    return __awaiter(this, void 0, void 0, function () {
        var docSnap, currentValue, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, db.doc("counters/count").get()];
                case 1:
                    docSnap = _a.sent();
                    if (docSnap.data()) {
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error("Error fetching counter:", error_1);
                    return [3 /*break*/, 3];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, db.collection("counters").doc("count").update({
                ...
                case 2:
                    error_2 = _a.sent();
                    console.error("Error incrementing counter:", error_2);
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
